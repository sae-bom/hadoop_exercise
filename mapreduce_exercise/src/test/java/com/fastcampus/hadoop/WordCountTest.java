...
public class WordCountTest {
    ...
    public void wordCountWithCounter() throws IOException {
        ...
        mapDriver1
                .withInput(new LongWritable(0L), new Text("dog dog cat ca_t owl cat"))
                .run();
        System.out.println(mapDriver1.getCounters().findCounter(WordCountWithCounter.Word.WITHOUT_SPECIAL_CHARACTER).getValue());
        assertEquals(5, mapDriver1.getCounters().findCounter(WordCountWithCounter.Word.WITHOUT_SPECIAL_CHARACTER).getValue());
        System.out.println(mapDriver1.getCounters().findCounter(WordCountWithCounter.Word.WITH_SPECIAL_CHARACTER).getValue());
        assertEquals(1, mapDriver1.getCounters().findCounter(WordCountWithCounter.Word.WITH_SPECIAL_CHARACTER).getValue());
    }
}
